#pragma checksum "C:\Users\tiend\source\repos\Tutorial3\Tutorial3\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "0C59741F648342BDCADF03CEB1161629"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Tutorial3
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj8_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Tutorial3.Model.NewsItem dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::Tutorial3.Model.NewsItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Tutorial3.Model.NewsItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::Tutorial3.Model.NewsItem obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Tutorial3.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Tutorial3.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Tutorial3.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_NewsItems(global::System.Collections.ObjectModel.ObservableCollection<global::Tutorial3.Model.NewsItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 13: // MainPage.xaml line 20
                {
                    ...
                    ((global::Windows.UI.Xaml.Controls.Button)this.HambugerButton).Click += this.HamburgerButton_Click;
                }
                break;
