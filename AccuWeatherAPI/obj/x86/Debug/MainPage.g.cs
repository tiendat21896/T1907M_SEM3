#pragma checksum "C:\Users\tiend\source\repos\AccuWeatherAPI\AccuWeatherAPI\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "2B17B085E016AB12BE3E21CE2C0A6EBA"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 61 && columnNumber == 177)
                {
                    isobj6SourceDisabled = true;
                }
                else if (lineNumber == 62 && columnNumber == 91)
                {
                    isobj7TextDisabled = true;
                }
                else if (lineNumber == 63 && columnNumber == 124)
                {
            ...
            private void Update_Temperature(global::AccuWeatherAPI.Models.Temperature1 obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Maximum(global::AccuWeatherAPI.Models.Maximum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Minimum(global::AccuWeatherAPI.Models.Minimum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 43 && columnNumber == 83)
                {
                    isobj12TextDisabled = true;
                }
                else if (lineNumber == 44 && columnNumber == 106)
                {
                    isobj13SourceDisabled = true;
                }
                else if (lineNumber == 45 && columnNumber == 113)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 34 && columnNumber == 23)
                {
